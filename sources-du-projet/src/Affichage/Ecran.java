...
public class Ecran extends Pane {
    ...
    public Ecran(double x,double y,Interface intf,String nom) {
        ...
        try {
            imageSoleilStandard = SwingFXUtils.toFXImage(ImageIO.read(this.getClass().getResource("/resources/soleil.png")), null);
            imageVaisseauStandard = SwingFXUtils.toFXImage(ImageIO.read(this.getClass().getResource("/resources/vaisseau.png")), null);
            imageFondStandard = SwingFXUtils.toFXImage(ImageIO.read(this.getClass().getResource("/resources/espace.jpg")), null);
            imagePlaneteStandard = SwingFXUtils.toFXImage(ImageIO.read(this.getClass().getResource("/resources/planete.png")), null);
    ...
    public double calcH(Objet o, double bonus){
        //Au vue du fait que les fenetres sont TOUJOURS carré, on n'a pas besoin de differencier hauteur et largeur;
    ...
    // [le decalageX et Y qui correspondent au décallage dû au déplacement à l'aide de la
    // souris] et [le Scale]
        ...
        for (Objet o : listObjet) {
            ...
            if (o instanceof Soleil) {
                ...
                graphicsContext.fillText(
                        o.getNom(),
                        (o.getPosx() + moitieX + decalageX) * scale,
                ...
                if(o.getNom().equals("Missile")) {
                    graphicsContext.drawImage(imagePlaneteStandard,
                            calcX(o),
                            calcY(o),
                            (o.getMasse()*2000) * scale,
                            (o.getMasse() * 2000) * scale);
                }
                else graphicsContext.drawImage(
                        imagePlaneteStandard,
                        calcX(o),
                        calcY(o),
                        calcW(o),
                        calcH(o));
    ...
    public Objet getFocus() {return focus;}
